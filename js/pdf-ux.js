$(document).ready(function () {
  try {
    ...
    let zipLevel = "";
    let baseUrlSection = "/ja-jp/cloud_volumes/pdfs/sidebar/";
    let baseUrlPages = "/ja-jp/cloud_volumes/pdfs/pages/";
    let zipFilename = "";
    let zipFileSize = 0;
    zipLevel = zipLevel !== ""?zipLevel:1;
    zipFilename = zipFilename !== ''?zipFilename:"cloud_volumes.ja-jp.zip";
